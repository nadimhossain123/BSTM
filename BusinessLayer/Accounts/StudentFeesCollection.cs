...
namespace BusinessLayer.Accounts
{
    public  class StudentFeesCollection
    {
        ...
        public DataSet GetStudentHostelOutstandingReport(int StudentId, string FromDate, string ToDate)
        {
            return DataAccess.Accounts.StudentFeesCollection.GetStudentHostelOutstandingReport(StudentId, FromDate, ToDate);
        }
    }
}
