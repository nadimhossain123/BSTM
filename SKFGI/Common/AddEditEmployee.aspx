                    ...
                    <tr>
                        <td align="center">
                            <asp:GridView ID="dgvEmployee" runat="server" AutoGenerateColumns="false" 
                                ...
                                OnRowDeleting="dgvEmployee_RowDeleting" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ShowHeader="false">
                                 ...
                                 <asp:TemplateField ShowHeader="false">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="~/Images/delete_icon.gif" CommandName="Delete" meta:resourcekey="BtnUserDeleteResource1" onClientClick="if ( !confirm('Are you sure you want to delete this Employee?')) return false;"  />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ShowHeader="false">
                                    <ItemTemplate>
