...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Validation()
        {
            ...
            else if (document.getElementById('<%=txtDAPercent.ClientID%>').value == '')
                return ShowMsg('Enter DA Percentage');
            else if (document.getElementById('<%=txtDAAmt.ClientID%>').value == '')
                return ShowMsg('Enter DA Amount');
        ...
        function OneTextToOther() 
        {
            ...
            var DA = document.getElementById('<%=txtDAAmt.ClientID%>').value;
            var GradePay = document.getElementById('<%=txtGradePay.ClientID%>').value;
            if (isNumber(Basic))
            {
                var Temp = ((Basic) * PFPer) + ((DA) * PFPer) + ((GradePay) * PFPer);
                var EmployeePF =Temp/100;
     ...
     function GetDAAmt() {
            ...
            var Percentage = document.getElementById('<%=txtDAPercent.ClientID%>').value;
            var Basic = document.getElementById('<%=txtBasic.ClientID%>').value;

            if (isNumber(Percentage) && isNumber(Basic)) {
                document.getElementById('<%=txtDAAmt.ClientID%>').value = (Basic * Percentage) / 100;
            }
            ...
            <div style="width: 680px;">
                <table width="100%" align="center" class="table">
                    ...
                    <tr>
                        ...
                        <td align="left" width="30%">
                            <asp:TextBox ID="txtDAPercent" runat="server"  CssClass="textbox_required" onkeyup="GetDAAmt();"
                        ...
                        <td align="left" width="30%">
                            <asp:TextBox ID="txtDAAmt" runat="server"  CssClass="textbox_disabled" Width="180px"
                                Enabled="false"
                                ></asp:TextBox>
                        </td>
                    </tr>
                   <tr>
                        ...
                        <td align="left" width="30%">
                            <asp:TextBox ID="txtGradePay" runat="server" CssClass="textbox_required" Width="180px" onkeyup="OneTextToOther();"
