        ...
        <ContentTemplate>
            <div style="width: 720px;">
                ...
                <tr>
                    ...
                    <tr>
                        <td align="left" colspan="2">
                            <asp:ComboBox ID="ddlStudent" runat="server" CssClass="WindowsStyle" DropDownStyle="DropDown"
                                AutoCompleteMode="SuggestAppend" CaseSensitive="false" Width="560px" DataValueField="id"  AutoPostBack="true"
                                DataTextField="StudentName" OnSelectedIndexChanged="ddlStudent_SelectedIndexChanged">
                            </asp:ComboBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="left" colspan="2">
                            <asp:DropDownList ID="ddlSemester" runat="server" CssClass="dropdownList" Width="250px" DataValueField="Value" DataTextField="Name">
                            </asp:DropDownList>
                        </td>
                    </tr>
                     <tr>
