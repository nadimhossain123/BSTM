<%@ Page Title="BSTM Registration" Language="C#" MasterPageFile="~/MasterAdmin.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="title">
            ...
            <table width="100%" align="center" class="table">
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <asp:RadioButton ID="rbOther" runat="server" Text="OTHER" GroupName="mbaRank" />&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    <td align="left" width="20%" class="label">
        ...
        <h6 align="left" style="color: #00356A;">
            7. List Of Document Required For Admission In BSTM
        </h6>
        <div style="width: 740px;">
            <table width="100%" align="center" class="table">
                <tr>
