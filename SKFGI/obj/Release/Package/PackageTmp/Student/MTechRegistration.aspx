...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="title">
        ...
        <div style="width: 740px;">
            ...
            <table width="100%" align="center" class="table">
                <tr>
                    <td align="left" width="30%" class="label" style="color: #00356A;">
                        GATE Score (If any)
                    </td>
                    <td align="left" >
                        <asp:TextBox ID="txtGateScore" runat="server" CssClass="textbox" Width="200px" onkeypress="return AmountOnly('txtGateScore',this);"></asp:TextBox>
                    </td>
                    <td align="left" width="20%" class="label" style="color: #00356A;">
                    </td>
                    <td align="left" width="30%">
        ...
        <h6 align="left" style="color: #00356A;">
            5. List Of Document Required For Admission In M.Pharma
        </h6>
        <div style="width: 740px;">
            <table width="100%" align="center" class="table">
                <tr>
        ...
        <div style="width: 740px;">
            <table width="100%" align="center" class="table">
                <tr>
                    <td align="left">
                        Admitted By :<span class="req">*</span></td>
                    <td align="right">
