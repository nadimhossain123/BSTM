<%@ Page Title="B.Pharm Registration" Language="C#" MasterPageFile="~/MasterAdmin.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function Validation() {
            ...
            //if (!checkforvaliddata(eval('document.forms[0].' + '<%=txtSchoolName.ClientID%>'), "School/College", 1)) return false;
            ...
            //if (!checkforvaliddata(eval('document.forms[0].' + '<%=txtSubmittedBy.ClientID%>'), "Admitted By", 1)) return false;
            return confirm('Are You Sure?');

        }

        window.onload = function () {
            var radios = document.forms[0].elements["RDBLateral"];
        ...
        function RadioClicked() {
            if (this.value == "True") {
                if (!checkforvaliddata(eval('document.forms[0].' + '<%=txtDSubject.ClientID%>'), "Major Subject", 1)) return false;
                if (!checkforvaliddata(eval('document.forms[0].' + '<%=txtDBoard.ClientID%>'), "Board/University", 1)) return false;
                if (!checkforvaliddata(eval('document.forms[0].' + '<%=txtDCollege.ClientID%>'), "Institution/College", 1)) return false;
                if (!checkforvaliddata(eval('document.forms[0].' + '<%=txtDYearOfPassing.ClientID%>'), "Year Of Passing", 1)) return false;
                if (!checkforvaliddata(eval('document.forms[0].' + '<%=txtDMarks.ClientID%>'), "Division & Percentage of Marks", 1)) return false;
    ...
    <div>
        ...
        <div style="width: 740px;">
            <table width="100%" align="center" class="table">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList ID="ddlBatch" runat="server" Width="210px" CssClass="dropdownList"
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <asp:RadioButton ID="rbAieee" runat="server" Text="AIEEE(JEE MAIN)" GroupName="enggRank" />&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtRankid" runat="server" CssClass="textbox" Width="200px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="left" width="20%" class="label">Registration No
                    </td>
                    <td>
                        <asp:TextBox ID="txtRegistrationNo" runat="server" CssClass="textbox" Width="200px"></asp:TextBox>
                    </td>
                    <td align="left" width="20%" class="label">University RollNo
                    </td>
                    <td>
        ...
        <h6 align="left" style="color: #00356A;">1. 4-yr. BST-BPHARMA courses are offered in the following branches</h6>
        <div style="width: 740px;">
            <table width="100%" align="center" class="table">
                <tr>
                    <td align="left" colspan="2">
                        ...
                        Mathematics are eligible for admission through WBJEE or AIEEE(JEE MAIN)
                        <br />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">
                        <%--<asp:DropDownList ID="ddlSchool" runat="server" CssClass="dropdownList" Width="290px">
                        </asp:DropDownList>--%>
                        <asp:TextBox ID="txtSchoolName" runat="server" MaxLength="200" CssClass="textbox" Style="width: 300px"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div style="width: 740px;">
            <table width="100%" align="center" class="table">
                ...
                <tr>
                    ...
                    <td align="left" width="30%">
                        <asp:TextBox ID="txtpin" runat="server" CssClass="textbox" Width="140px"
        ...
        <h6 align="left" style="color: #00356A;">6. List Of Document Required For Admission In BST-BPHARMA
        </h6>
        <div style="width: 740px;">
            <table width="100%" align="center" class="table">
                <tr>
                ...
                <tr>
                    ...
                    <td class="label" align="left">Caste Certificate in respect of SC 1ST candidates (if applicable).
                    </td>
                </tr>
                <tr>
        ...
        <div style="width: 740px;">
            <table width="100%" align="center" class="table">
                <tr>
                    <td align="left">Admitted By :<span class="req">*</span></td>
                    <td align="right">
                        <asp:TextBox ID="txtSubmittedBy" runat="server" CssClass="textbox_required"
