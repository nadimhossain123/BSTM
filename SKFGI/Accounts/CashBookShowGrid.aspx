<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBookShowGrid.aspx.cs" Inherits="SKFGI.Accounts.CashBookShowGrid" %>
            ...
            <table border="0" width="100%" id="Content">
                <tr>
                    <td align="center">
                        ...
                        <asp:Image ID="imgHeader" runat="server" Height="120px"   />
                    </td>
                </tr>
                <tr>
                    <td align="center" valign="middle" width="100%" class="header">
                        <asp:Label ID="lblReportHeader" runat="server" Font-Size="X-Large"></asp:Label>
                    </td>
                </tr>
                <tr>
