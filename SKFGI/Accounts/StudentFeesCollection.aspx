...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function TotalAmount() {
            ...
            var rowIdx = 1;
            for (rowIdx; rowIdx <= rCount - 2; rowIdx++) {
            ...
            if (document.getElementById('<%=ddlCourse.ClientID%>').value != 4) {
                gv.rows[18].cells[4].innerHTML = amt.toFixed(2);
                document.getElementById('<%=txtTotalAmt.ClientID%>').value = amt.toFixed(2);
            }
            else {
                gv.rows[12].cells[4].innerHTML = amt.toFixed(2);
                document.getElementById('<%=txtTotalAmt.ClientID%>').value = amt.toFixed(2);
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UP1" runat="server">
        <ContentTemplate>
            ...
            <br />
            <h6 align="left" style="color: #00356A;">Money Receipt Information</h6>
            <table width="97%" align="center" class="table">
                <tbody>
                    <tr>
                        <td align="left" class="label" width="10%">Money Receipt No :
                        </td>
                        <td align="left" width="20%">
                            <asp:TextBox ID="txtReceiptNo" runat="server" CssClass="textbox_pink" Enabled="false"
                                Width="170px"></asp:TextBox>
                        </td>
                        <td align="left" class="label" width="10%">Voucher Date :
                        </td>
                        <td align="left" width="20%">
                        ...
                        <td align="left" class="label" width="10%">Mode Of Payment :
                        </td>
                        <td align="left" width="20%">
                    ...
                    <tr>
                        <td align="left" class="label" width="10%">Cash/Bank Ledger :
                        </td>
                        <td align="left" width="20%">
                    ...
                    <tr>
                        <td width="10%" align="left" class="label">Fees Book No
                            <%--<span class="req">*</span>--%>
                        </td>
                        ...
                        <td width="10%" align="left" class="label">Drawn On :
                        </td>
                        <td align="left">
                    ...
                    <tr>
                         <td align="left" width="10%" class="label">Course<span class="req">*</span>
                        </td>
                        ...
                        <td align="left" width="10%" class="label">Semester/Year<span class="req">*</span>
                        </td>
                        <td align="left">
            ...
            <br />
            <h6 align="left" style="color: #00356A;">Student Information</h6>
            <table width="97%" align="center" class="table">
                <tr>
                    <td width="15%" align="left" class="label">Batch :
                    </td>
                    ...
                    <td width="15%" align="left" class="label">Course :
                    </td>
                    <td align="left" width="15%">
                    ...
                    <td width="15%" align="left" class="label">Stream :
                    </td>
                    <td align="left" width="15%">
                ...
                <tr>
                    <td width="15%" align="left" class="label">Student Name : 
                    </td>
                   ...
                   <td width="15%" align="left" class="label">
                        <a href="../Student/StudentCreditBillEntry.aspx" target="_blank">Student Credit Bill Entry</a>
                    </td>
            ...
            <table width="97%" align="center">
                <tr>
                    ...
                    <td align="center" valign="top" colspan="2">
                        <asp:GridView ID="dgvFeesHead" runat="server" Width="100%" GridLines="None" AutoGenerateColumns="false"
                            AllowPaging="false" DataKeyNames="id,AssestLedgerID_FK" ShowFooter="true"
                            OnRowDataBound="dgvFeesHead_RowDataBound">
                            <Columns>
                                <asp:BoundField DataField="fees" HeaderText="Fees Head" FooterStyle-Font-Bold="true" FooterText="Total" FooterStyle-HorizontalAlign="Right"/>
                                ...
                                <asp:BoundField DataField="Advance" HeaderText="Advance" DataFormatString="{0:F2}"
                                    ItemStyle-HorizontalAlign="Right" ItemStyle-Width="90px" />--%>
                                <asp:TemplateField HeaderText="Bill" ItemStyle-Width="90px" ItemStyle-HorizontalAlign="Right" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right" FooterStyle-Width="90px">
                                    <ItemTemplate>
                                        <%#Eval("BillAmount") %>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label runat="server" ID="lblTotalBill"></asp:Label>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Due" ItemStyle-Width="90px" ItemStyle-HorizontalAlign="Right" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right" FooterStyle-Width="90px">
                                    <ItemTemplate>
                                        <%#Eval("Due") %>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label runat="server" ID="lblTotalDue"></asp:Label>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Advance" ItemStyle-Width="90px" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" FooterStyle-Font-Bold="true" FooterStyle-Width="90px">
                                    <ItemTemplate>
                                        <%#Eval("Advance") %>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label runat="server" ID="lblTotalAdvance"></asp:Label>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Amount" ItemStyle-Width="90px" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right" FooterStyle-Width="90px">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtAmount" runat="server" CssClass="textbox_green" Text='<%#Bind("Due") %>' onkeyup="TotalAmount()"
                ...
                <tr class="RowStyle">
                    ...
                    <td align="left" width="98px">
                        <asp:TextBox ID="txtTotalAmt" runat="server" CssClass="textbox_yellow" Text="0.00" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
            </table>
            <table width="97%" align="center" class="table">
                <tr>
                    <td align="left" width="15%" valign="top" class="label">Narration:
                    </td>
