    ...
    public partial class RPTProfitLoss : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ltrBalanceSheetHeading.Text = @"<b>Balance Sheet as at</b><br /><br />" + Session["SesToDate"].ToString();
                PopulateGrid();
            }
        ...
        protected void btnPLExport_Click(object sender, EventArgs e)
        {
            ...
            _header[0] = "<b>Income & Expenditure Statement</b>";
            ...
            _header[1] = Session["SesFromDate"].ToString() + " to " + Session["SesToDate"].ToString();
            _header[2] = "";
