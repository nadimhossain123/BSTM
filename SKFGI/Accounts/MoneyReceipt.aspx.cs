            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (Refund == 0)//---------Add On 10-08-2013
                {
                    if (Session["CompanyId"].ToString() == "1")
                        ltrFooter.Text = "Please pay Cheque/DD in favour of Bengal School of Technology & Management. (BSTM-MGMT)";
                    else
                        ltrFooter.Text = "Please pay Cheque/DD in favour of Bengal School of Technology & Management. (BSTM-ENGG)";
                    ltrPaidBy.Text = "";
