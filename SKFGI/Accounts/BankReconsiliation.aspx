...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function UpdateClearDateValidation() {
            var gv = document.getElementById('<%=gvBRView.ClientID%>');
             var rowCount = gv.rows.length - 1;
             ...
             else if (document.getElementById('<% = txtNewClearDate.ClientID%>').value == '') {
                 alert('Enter New Clear Date');
                 return false;
             }
                        ...
                        <tr>
                         ...
                         <tr>
                              <td class="label" align="left" >
                                ...
                                <asp:TextBox ID="txtNewClearDate" Width="137px" CssClass="textbox" runat="server"
                                MaxLength="12"></asp:TextBox>
                                <asp:CalendarExtender ID="CalendarExtender2" runat="server" CssClass="cal_Theme1"
                                Format="dd MMM yyyy" TargetControlID="txtNewClearDate"
                                OnClientDateSelectionChanged="" Enabled="True">
                               </asp:CalendarExtender>
                                   <asp:Button ID="btnUpdateClearDate" runat="server" Text="Update Clear Date" OnClick="btnUpdateClearDate_Click"
                                        CssClass="button" OnClientClick="return UpdateClearDateValidation();"></asp:Button>
