...
namespace CollegeERP.Accounts
{
    public partial class RPTGridViewDiploma : System.Web.UI.Page
    {
        ...
        protected void LoadSignature()
        {
            ...
            sb.Append(@"</td><td width='5%'></td><td width='20%' align='center' style='border-top: dotted 1px #000'>Cashier</td>");
            sb.Append(@"<td width='5%'></td><td width='20%' align='center' style='border-top: dotted 1px #000'>Received By</td></tr>");
            sb.Append(@"</table>");
